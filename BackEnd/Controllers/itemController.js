...
itemController.addItem = (req, res, next) => {
  ...
  const queryString =
    'INSERT INTO itemtable (name, description, neighborhood, _owner, borrowed) ' +
    'VALUES ($1, $2, $3, $4, $5)';
...
itemController.deleteItem = (req, res, next) => {
  ...
  //ADDED _owner = $2 TO MAKE SURE ONLY THE OWNER HAVE THE RIGHT TO DELETE THE ITEM(EDGE CASE MAYBE?)
  const { id, username } = req.body;
  const queryString = 'DELETE FROM itemtable WHERE id = $1 AND _owner = $2';
